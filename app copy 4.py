...
[Continue for top emerging threats from Table 2]
...
Based on what's NOT in the competitor tables:
- **Underserved settings**: Which lines of therapy or patient populations show limited competitor activity?
- **EMD differentiation opportunities**: Where can EMD assets uniquely position?
- **Potential combination strategies**: What partnerships could strengthen EMD positioning?
        ...
        try:
            ...
            if "all_data" in playbook.get("required_tables", []):
                ...
                if playbook_key == "competitor":
                    ...
                    # Define indication keywords and MOA classes based on TA focus
                    indication_keywords = []
                    focus_moa_classes = None

                    if ta_filters and ta_filters[0] == "Bladder Cancer":
                        indication_keywords = ["bladder", "urothelial", "uroepithelial", "transitional cell"]
                        focus_moa_classes = ["ICI", "ADC", "Targeted Therapy", "Bispecific Antibody", "FGFR Inhibitor"]
                    elif ta_filters and ta_filters[0] == "Lung Cancer":
                        indication_keywords = ["lung", "NSCLC", "non-small cell"]
                        focus_moa_classes = ["TKI", "ADC", "ICI", "Targeted Therapy", "MET Inhibitor", "EGFR Inhibitor"]
                    elif ta_filters and ta_filters[0] == "Colorectal Cancer":
                        indication_keywords = ["colorectal", "CRC", "colon", "rectal", "bowel"]
                        focus_moa_classes = ["Targeted Therapy", "ICI", "ADC", "Bispecific Antibody", "EGFR Antibody"]
                    elif ta_filters and ta_filters[0] == "Head & Neck Cancer":
                        indication_keywords = ["head and neck", "head & neck", "H&N", "HNSCC", "SCCHN", "oral", "pharyngeal", "laryngeal"]
                        focus_moa_classes = ["Targeted Therapy", "ICI", "ADC", "Bispecific Antibody", "EGFR Antibody"]
                    elif ta_filters and ta_filters[0] == "Renal Cancer":
                        indication_keywords = ["renal", "renal cell", "RCC", "kidney"]
                        focus_moa_classes = ["ICI", "TKI", "HIF-2α Inhibitor", "Targeted Therapy"]
                    elif ta_filters and ta_filters[0] == "TGCT":
                        indication_keywords = ["TGCT", "tenosynovial", "giant cell", "PVNS"]
                        focus_moa_classes = ["CSF1R Inhibitor", "Targeted Therapy"]
