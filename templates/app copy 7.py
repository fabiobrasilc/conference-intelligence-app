...
Provide a brief summary of these findings, mentioning the count and any notable patterns in the research areas or institutions involved."""
                    ...
                    if institution_entities:
                        ...
                        # Search in Affiliation column for institution mentions
                        mask = filtered_df["Affiliation"].str.contains("MD Anderson", case=False, na=False)
                        ...
                        if not institution_results.empty:
                            ...
                            table_title = f"MD Anderson Studies - ESMO 2025 ({len(institution_results)} sessions)"
