...
# ============================================================================
# LEGACY IMPORTS REMOVED - Replaced by AI-First Architecture
# ============================================================================
...
# from improved_search import precompute_search_text - MOVED INLINE BELOW

# ============================================================================
# SEARCH TEXT PRECOMPUTATION (moved from improved_search.py)
# ============================================================================

def precompute_search_text(df: pd.DataFrame) -> pd.DataFrame:
    """
    Create a concatenated 'search_text' field for each row.
    Combines all searchable columns for efficient multi-field filtering.

    Columns included: Identifier, Title, Session, Theme, Speakers,
    Affiliation, Speaker Location, Room, Date, Time

    Returns DataFrame with added 'search_text' and 'search_text_normalized' columns.
    """
    df = df.copy()

    searchable_columns = [
        'Identifier', 'Title', 'Session', 'Theme', 'Speakers',
        'Affiliation', 'Speaker Location', 'Room', 'Date', 'Time'
    ]
...
ESMO_THERAPEUTIC_AREAS = {
    ...
    "Head and Neck Cancer": {
        "keywords": ["head and neck", "head & neck", r"\bhnscc\b", r"\bscchn\b",
                     "squamous cell carcinoma of the head", "oral cavity", "pharyngeal", "laryngeal", "oropharyngeal", "nasopharyngeal"],
        "exclude_if_in_title": ["esophageal", "gastric", "lung", "thyroid", "salivary gland carcinoma",
                               "colorectal", "breast", "prostate", "cervical", "uterine", "ovarian",
                               "endometrial", "sarcoma", "melanoma", "merkel"],
        "regex": True
    },
    "TGCT": {
...
# ============================================================================
# LEGACY ENDPOINTS REMOVED - See app_backup_pre_cleanup_20251008.py
# Removed: /api/chat/stream (lines 4514-4664)
# Removed: /api/chat/enhanced (lines 4666-4843)
# These were replaced by /api/chat/ai-first (AI-first two-step flow)
# ============================================================================
